...
float cameraViewY = 0.0f;
float cameraViewZ = -3.0f;
...
int main()
{
    ...
    Shader ourShader("../include/GLshader.vs", "../include/GLshader.fs");
...
glm::vec3 cubePositions[] = {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        view       = glm::translate(view,glm::vec3(cameraViewX, cameraViewY, cameraViewZ));
